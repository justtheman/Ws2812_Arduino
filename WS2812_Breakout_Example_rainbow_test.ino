...
void loop()
{
  ...
  for (int i=0; i<2; i++)
  {
    ...
    cylon(FUCHSIA, 70);  // Indigo cylon eye!
  }
  for (int i=0; i<2; i++)
  {
    // cylon function: first param is color, second is time (in ms) between cycles
    cylon(LIME, 70);  // Indigo cylon eye!
  }
  for (int i=0; i<2; i++)
  {
    // cylon function: first param is color, second is time (in ms) between cycles
    cylon(RED, 50);  // Indigo cylon eye!
  }
  for (int i=0; i<2; i++)
  {
    // cylon function: first param is color, second is time (in ms) between cycles
    cylon(CYAN, 50);  // Indigo cylon eye!
  }
...
void rainbow(byte startPosition) 
{
  ...
  for (int i=0; i<192; i++)
  {
    ...
    leds.setPixelColor(j, rainbowOrder((rainbowScale * (i + startPosition)) % 192));
  }
    leds.show();
    delay(500);
